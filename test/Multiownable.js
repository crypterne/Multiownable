...
contract('Multiownable', function ([_, wallet1, wallet2, wallet3, wallet4, wallet5]) {
    ...
    it('should allow to transfer ownership to the exctly 128 owners', async function () {
        const obj = await Multiownable.new();
    ...
    it('should allow to add more than 256 owners', async function () {
        ...
        (await obj.ownersCount.call()).should.be.bignumber.equal(1 + 128);
        ...
        (await obj.ownersCount.call()).should.be.bignumber.equal(1 + 128 * 2);
        ...
        (await obj.ownersCount.call()).should.be.bignumber.equal(1 + 128 * 3);
        ...
        (await obj.ownersCount.call()).should.be.bignumber.equal(1 + 128 * 4);
    });
});
